...
// const destJsPath = path.join(webFilesDir, 'stripe-payment.js');
// const destCssPath = path.join(webFilesDir, 'stripe-payment.css');
const destJsPath = path.join(webFilesDir, 'applicant-financial.js');
const destCssPath = path.join(webFilesDir, 'applicant-financial.css');
